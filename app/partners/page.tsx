          ...
          >
            {CATEGORIES.map((c, i) => (
              <div key={i} className="glass-card" style={{ padding: "24px 20px" }}>
                <div style={{ width: 46, height: 46, borderRadius: 11, background: `rgba(30,136,229,0.1)`, border: `1px solid ${c.color}33`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 20, marginBottom: 14 }}>
                  {c.icon}
                </div>
                ...
                <ul style={{ listStyle: "none", display: "flex", flexDirection: "column", gap: 6 }}>
                  {c.benefits.map((b, j) => (
                    <li key={j} style={{ display: "flex", gap: 7, fontSize: 11.5, color: "rgba(255,255,255,0.62)" }}>
