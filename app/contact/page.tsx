        ...
        <div className="container" style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(300px,1fr))", gap:48 }}>
          ...
          <div>
            ...
            <div style={{ display:"flex", flexDirection:"column", gap:28 }}>
              {[
                { icon:"📍", label:"Head Office", val:"[Address Placeholder]\nIndia" },
                { icon:"📞", label:"Phone",        val:"+91 [Phone Placeholder]" },
                { icon:"✉️", label:"Email",        val:"info@alpha1itsolutions.com" },
                { icon:"🌐", label:"Website",      val:"www.alpha1itsolutions.com" },
                { icon:"🕐", label:"Office Hours", val:"Mon – Sat: 9:00 AM – 6:30 PM IST\nSupport: 24 × 7" },
              ].map((c, i) => (
                <div key={i} style={{ display:"flex", gap:16, alignItems:"flex-start" }}>
                  <div style={{ width:44, height:44, borderRadius:10, background:"rgba(30,136,229,0.12)", border:"1px solid rgba(30,136,229,0.22)", display:"flex", alignItems:"center", justifyContent:"center", fontSize:20, flexShrink:0 }}>
                    {c.icon}
                  </div>
                  <div>
            ...
            <div style={{ marginTop:36 }}>
              ...
              <div style={{ display:"flex", gap:12 }}>
                <a href="#" style={{ fontSize:12, padding:"6px 14px", background:"rgba(30,136,229,0.12)", border:"1px solid rgba(30,136,229,0.22)", borderRadius:6, color:"rgba(255,255,255,0.65)", textDecoration:"none", display:"flex", alignItems:"center", gap:6 }}>
                  🔗 LinkedIn
                </a>
                <a href="#" style={{ fontSize:12, padding:"6px 14px", background:"rgba(30,136,229,0.12)", border:"1px solid rgba(30,136,229,0.22)", borderRadius:6, color:"rgba(255,255,255,0.65)", textDecoration:"none", display:"flex", alignItems:"center", gap:6 }}>
                  <span style={{ fontFamily: "sans-serif", fontWeight: "bold" }}>𝕏</span> X
                </a>
                <a href="#" style={{ fontSize:12, padding:"6px 14px", background:"rgba(30,136,229,0.12)", border:"1px solid rgba(30,136,229,0.22)", borderRadius:6, color:"rgba(255,255,255,0.65)", textDecoration:"none", display:"flex", alignItems:"center", gap:6 }}>
                  📘 Facebook
                </a>
