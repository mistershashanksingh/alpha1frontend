...
const AWARDS = [
  { icon: "🏆", title: "Best IT Partner",        sub: "Regional Excellence Award"     },
  { icon: "🥇", title: "ManageEngine Partner",    sub: "Gold Certified Partner"        },
  { icon: "🔐", title: "ISO 27001",               sub: "Information Security Certified" },
  { icon: "✅", title: "Cyberstanc Certified",    sub: "Authorised Solution Provider"   },
];
    ...
    <>
      ...
      <section style={{ padding:"80px 24px" }}>
        <div className="container" style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(300px,1fr))", gap:48 }}>
          ...
          <div>
            <div className="section-badge">⚙️ Expertise</div>
            ...
            {TEAM.map((t, i) => (
              <div key={i} className="glass-card" style={{ padding:32, textAlign:"center" }}>
                ...
                <div style={{ display:"flex", justifyContent:"center", gap:12, marginTop:16 }}>
                  {["in","tw","em"].map((s) => (
                    <div key={s} style={{ width:30, height:30, borderRadius:"50%", background:"rgba(30,136,229,0.15)", border:"1px solid rgba(30,136,229,0.25)", display:"flex", alignItems:"center", justifyContent:"center", fontSize:12, color:"rgba(255,255,255,0.5)", cursor:"pointer" }}>
                      {s === "in" ? "🔗" : s === "tw" ? "𝕏" : "✉️"}
                    </div>
                  ))}
                </div>
